...
<table width="680" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit" style="font-family: Helvetica, Arial, sans-serif;font-size: 14px; line-height: 18px;">
	...
	<tr>
        ...
        <p>Auf unserer Seite wurde angefordert Ihr Passwort zurückzusetzen. Falls Sie dieses nicht beabsichtigt haben, ignorieren Sie bitte diese E-Mail oder wenden sich direkt an uns.</p>

        <p>
          <a href="{{ $app_url }}{{ $endpoint }}{{ $token }}">Passwort zurücksetzen</a>
        </p>

				<p>Oder öffnen Sie folgenden Link manuell in Ihrem gewünschten Browser:</p>

				<p>
					{{ $app_url }}{{ $endpoint }}{{ $token }}
				</p>

				<p>
					<i>Der Link ist nur für 24 Stunden aktiv. Falls Sie erneut das Passwort zurücksetzen möchten, kehren Sie bitte auf unsere Webseite {{ $app_url }} zurück.</i>
				</p>
